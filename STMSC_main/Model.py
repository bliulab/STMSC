...
class Model():
    ...
    def __init__(self, adata_st, adata_basis,
        ...
        # build model
        if distribution == "DeconvNet1":
            self.net = DeconvNet1(hidden_dims=self.hidden_dims,
        ...
        #     self.net = DeconvNet2(hidden_dims=self.hidden_dims,
        #                          n_celltypes=self.n_celltype,
        #                          n_slices=self.n_slices,
        #                          n_heads=n_heads,
        #                          slice_emb_dim=slice_emb_dim,
    ...
    def eval(self, adata_st_list_raw, save=True, output_path="/home/zhangdaijun/code/STitch3D-main/results_DLPFC"):
        self.net.eval()
